...
$.ajax({url:u,dataType:'json',success:function(data){$.each(data.feed.entry,function(index,item){var picasaSrc,picasaCaption=cap,delay="";if(typeof o.attr('data-ob_delayTimer')!=="undefined"&&o.attr('data-ob_delayTimer')!=="0"){delay='data-ob_delayTimer="'+o.attr('data-ob_delayTimer')+'"';}
...
if(oB.settings.addThis&&obj.data('oB').share!=="false"){addThis.addClass("ob_share");if(title===""){title="&nbsp;";}
$('#ob_title').append(addThis);addthis.button('.ob_share',{services_compact:'twitter,facebook,digg,delicious,more',ui_offset_left:-244,ui_offset_top:4},{url:ob_link,title:title});$('#ob_share').html('').append(shareHTML);}
